...
class Comfirmhp extends StatelessWidget {
  @override
        ...
        Center(
            child: Column(
              children: [
                ...
                Text("Masukan No Handphone anda untuk proses verifikasi kami akan mengirimkan kode 4 digit ke No Handphone anda", style: GoogleFonts.poppins(fontSize: 14),),
...
SizedBox(height: 30,),
                ...
                GestureDetector(onTap: (){
                  ...
                  Container(
                      ...
                      height: 50,
                      child: Center(
                        child: Text("Lanjut", style: GoogleFonts.poppins(fontSize: 14),),
                      )
                  )
                  ,
                )
